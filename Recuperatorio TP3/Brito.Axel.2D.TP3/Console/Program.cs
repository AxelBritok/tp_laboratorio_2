...
namespace Console
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            System.Console.WriteLine(gim.ToString());
            System.Console.ReadKey();
            try
            {
                Universidad.Guardar(gim);
                System.Console.WriteLine("Archivo de Universidad guardado");
            }
            ...
            try
            {
                ...
                System.Console.WriteLine("Archivo de Jornada {0} guardado", jornada);
